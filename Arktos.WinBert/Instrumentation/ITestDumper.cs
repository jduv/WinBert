namespace Arktos.WinBert.Instrumentation
{
    ...
    public interface ITestDumper
    {
        ...
        /// <summary>
        /// Ends a test case, saving all information about the current execution stack to the target path. If the 
        /// file is unable to be saved properly then this method should fail quietly.
        /// </summary>
        /// <param name="path">
        /// The path to save the file to.
        /// </param>
        void EndTest(string path);
        ...
        /// </param>
        void DumpVoidInstanceMethodCall(object target, string signature);
        ...
        /// The signature of the method that was executed.
        /// </param>
        void DumpInstanceMethodCall(object target, object returnValue, string signature);
