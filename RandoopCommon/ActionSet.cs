...
namespace Randoop
{
    ...
    public class ActionSet
    {
        ...
        public MemberInfo RandomMethodOrConstructorRoundRobin()
        {
            ...
            int randomIndex = RandoopEnvironment.Instance.Randomizer.Next(roundRobinList.Count);
        ...
        {
            return methodsAndConstructorsArray[RandoopEnvironment.Instance.Randomizer.Next(methodsAndConstructorsArray.Length)];
        }
        ...
        public MemberInfo RandomActiveMethodorConstructor(Dictionary<Type, List<MemberInfo>> activeMembers, Type t)
        {
            try
            {
                ...
                return memberList[RandoopEnvironment.Instance.Randomizer.Next(memberList.Count)];
        ...
        {
            return fieldList[RandoopEnvironment.Instance.Randomizer.Next(fieldList.Count)];
        }
