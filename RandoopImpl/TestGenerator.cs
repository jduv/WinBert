    ...
    public class RandomExplorer //: ExplorationContext
    {
            ...
            bool forbidNull, bool mutateFields, bool fairOpt)
        {
            ...
            if (fairOpt)
            {
                ...
                for (; ; )
                {
                    ...
                    //field setting
                    if (mutateFields && this.actions.fieldList.Count > 0 && RandoopEnvironment.Instance.Randomizer.Next(2) == 0)
            ...
            PlanDataBase planDB, bool forbidNull, MethodInfo method)
        {
            ...
            for (int i = 0; i < typesDesired.Length; i++)
            {
                ...
                {
                    int randArrayLength = RandoopEnvironment.Instance.Randomizer.Next(this.arrayMaxSize + 1);
                ...
                else
                {
                    ...
                    parameterMap[i] =
                        new Plan.ParameterChooser(i, possibleResultIndices[RandoopEnvironment.Instance.Randomizer.Next(possibleResultIndices.Count)]);
